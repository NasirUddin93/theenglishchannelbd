...
export default function About() {
  ...
  return (
    <div className="space-y-28 pb-24 overflow-x-hidden">
      <div className="space-y-8 bg-white/80 backdrop-blur-sm rounded-3xl shadow-sm shadow-[0_0_30px_rgba(255,167,38,0.1)] ring-1 ring-orange-100 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <FadeIn key={i} delay={i * 0.1}>
              <div className={`group relative h-full p-8 bg-white rounded-3xl border border-gray-100 shadow-[0_0_20px_rgba(255,167,38,0.2)] ${f.border}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <FadeIn direction="left">
            <div className="h-full rounded-3xl bg-white border border-gray-100 shadow-[0_0_20px_rgba(255,167,38,0.2)] hover:border-orange-100 hover:shadow-xl hover:shadow-orange-50 transition-all duration-300 overflow-hidden">
              {/* Card top accent */}
          ...
          <FadeIn direction="right">
            <div className="h-full rounded-3xl bg-white border border-gray-100 shadow-[0_0_20px_rgba(255,167,38,0.2)] hover:border-amber-100 hover:shadow-xl hover:shadow-amber-50 transition-all duration-300 overflow-hidden">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {about.contact_email && (
            <FadeIn delay={0}>
              <a href={`mailto:${about.contact_email}`}
                className="group relative flex flex-col items-center text-center p-9 bg-white rounded-3xl border border-gray-100 shadow-[0_0_20px_rgba(255,167,38,0.2)]
          ...
          {about.contact_address && (
            <FadeIn delay={0.2}>
              <div className="group relative flex flex-col items-center text-center p-9 bg-white rounded-3xl border border-gray-100 shadow-[0_0_20px_rgba(255,167,38,0.2)]
